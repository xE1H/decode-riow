...
public class PointsSpecimen {
    ...
    public static Pose PICK_UP_SAMPLE_1 = new Pose(29, 15.2 + OFFSET, Math.toRadians(0));
    ...
    public static Pose SCORE_SECOND_SPECIMEN = new Pose(34.25, 58.5 + OFFSET, Math.toRadians(0));

    public static Pose DRIVE_BACK = new Pose(28, 58.5 + OFFSET, Math.toRadians(0));
