...
public class SetEffectTime extends InstantCommand {
    public SetEffectTime(double time){
        super(()-> VLRSubsystem.getInstance(NeoPixelSubsystem.class).setEffectTime(time));
    }
}
