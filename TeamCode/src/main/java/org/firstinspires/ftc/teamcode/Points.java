...
public class Points {
    ...
    public static Pose BUCKET_HIGH_SCORE_POSE = new Pose(26, 118, -50);
    ...
    public static Pose SUB_PRE_BEZIER_POSE = new Pose(72,140, -90);
    public static Pose SUB_GRAB_POSE = new Pose(64,95, -90);
